<template>
  <div class="shadow" style="padding: 2em">
    <p>
      Feel free to drop me a line using the form below! I generally will reply
      within 1 business day. I look forward to connecting with you.
    </p>
    <form name="contactForm" @submit.prevent="submit()">
      ...
      <div class="form-group">
        <input type="submit" value="Send" :disabled="formDisabled" />
      </div>
    </form>
    ...
    return {
      ...
      submit: function () {
        if (this.formData.validation.toLowerCase() !== 'blue') {
          ...
          this.error = false
          const url =
            'https://submit-form.com/bec5c59a-c529-4097-b121-5059403ada83'
          let body = {
          ...
          fetch(url, requestOptions)
            ...
            .catch((err) => {
              this.error = true
              this.message =
                'There was an error processing the form, please try again or contact the webmaster @ contact(dot)gharahi[dot]c0m.'
              console.log(err)
            })
        }
      },
