<template>
  <div class="post">
    ...
    <a target="_blank" rel="noopener" :href="'hhttps://github.com/kushagharahi/kushagharahi.github.io/tree/dev/rc/content/blog/posts/' + $route.params.name + '/post.md'">Suggest a change to this post here! (requires a GitHub account)</a>
  </div>
</template>
