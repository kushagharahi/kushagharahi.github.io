...
export default {
  ...
  mounted: function () {
    this.terminalOutCommand(
      document.getElementById('shell-body'),
      'man about | cat',
    ).then(() => {
      this.terminalOutHtml(
        document.getElementById('shell-body'),
        "<br />(about1)<br /> \
          Hi,<br /> \
          ...
          👀 Peep the latest blog post -> <a href='/blog/" +
          this.latestPostMetadata.name +
          "/'>" +
          this.latestPostMetadata.title +
          "</a> <br /><br /> \
